...
def select_action(state, valid_moves_here):
    ...
    valid_moves_array = np.array(valid_moves_here)
...
def train_dqn():
    ...
    with tf.GradientTape() as tape:
        predicted_q_values = tf.reduce_sum(dqn_model(preprocessed_states) * preprocessed_actions, axis=1)
